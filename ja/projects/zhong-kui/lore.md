...
**8月20日——「質素な一食」：** **8月20日**（『黒神話：悟空』発売2周年）に大きな動きがあるのかという質問に対し、楊奇は実機映像や新予告編を期待しないよう示唆しつつ、それを「旧友の集まり」「質素な一食」と表現。新年の短編動画のようなスタイルの軽量CGが公開される可能性が高いとみられます。

> 注：AIGC不使用の方針は『鍾馗』のデザイン・アセット制作段階に関するものです。「質素な一食」は期待値を調整するための示唆であり、確定したロードマップではありません。
